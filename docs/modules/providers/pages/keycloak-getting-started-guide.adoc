...
. Under *Web Origins* you must set the proxy's host URL, in the *Allowed CORS Origins* in order to prevent CORS errors. Take care to end it with a `/`. 

. Make sure to add the proxy's redirect URI to the list of *Valid Redirect URIs*.
