...
let requestData = {
  ...
  "client_id": "http://localhost:3002/tonypaillard/profile/card#me",
  "redirect_uris": [
...
window.location = `http://localhost:${env.VITE_OIDC_PORT}/auth?response_type=code&code_challenge=${code_challenge}&code_challenge_method=S256&scope=openid&client_id=http%3A%2F%2Flocalhost:3002%2Ftonypaillard%2Fprofile%2Fcard%23me&redirect_uri=http%3A%2F%2F${env.VITE_IP}:${env.VITE_PORT}%2Frequests.html`
