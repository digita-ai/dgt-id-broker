...
export class PassThroughHttpRequestHandler extends HttpHandler {
   ...
   */
  constructor(public scheme: string, public host: string, public port: number) {
    super();
  ...
  private fetchRequest(
    ...
    const requestOpts: RequestOptions = { protocol: `${this.scheme}:`, hostname: this.host, port: this.port, path, method, headers: outgoingHttpHeaders };
